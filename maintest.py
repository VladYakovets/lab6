...
Y1 = [9.6 + 8.9*X1[i] + 8.6*X2[i] + 2.6*X3[i] + 6.4*X8[i] + 0.8*X9[i] + 7.2*X10[i] + 7.9*X12[i] + 0.8*X13[i] + 9.8*X23[i] + 9.0*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
Y2 = [9.6 + 8.9*X1[i] + 8.6*X2[i] + 2.6*X3[i] + 6.4*X8[i] + 0.8*X9[i] + 7.2*X10[i] + 7.9*X12[i] + 0.8*X13[i] + 9.8*X23[i] + 9.0*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
Y3 = [9.6 + 8.9*X1[i] + 8.6*X2[i] + 2.6*X3[i] + 6.4*X8[i] + 0.8*X9[i] + 7.2*X10[i] + 7.9*X12[i] + 0.8*X13[i] + 9.8*X23[i] + 9.0*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
...
for i in range(11):
    for j in range(11):
        b0m[i][j][i] = k[j]
for i in range(11):
    b.append(float(np.linalg.det(b0m[i]))/np.linalg.det(m))
print(b)
for i in range(15):
...
beta8 = (y1av1*1+y2av2*1+y3av3*1+y4av4*1+y5av5*1+y6av6*1+y7av7*1+y8av8*1+y9av9*2.99+y10av10*2.99)/15
beta9 = (y1av1*1+y2av2*1+y3av3*1+y4av4*1+y5av5*1+y6av6*1+y7av7*1+y8av8*1+y11av11*2.99+y12av12*2.99)/15
beta10 = (y1av1*1+y2av2*1+y3av3*1+y4av4*1+y5av5*1+y6av6*1+y7av7*1+y8av8*1+y13av13*2.99+y14av14*2.99)/15
